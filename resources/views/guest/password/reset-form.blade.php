                    ...
                    <form action="{{ route('reset.password') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" name="email" class="form-control input_user"
                                placeholder="Enter email" value="{{ $email ?? old('email') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" name="password-confirm" class="form-control input_pass"
                                value="{{ old('password-confirm') }}" placeholder="Enter confirm password">
                            <span class="text-danger">

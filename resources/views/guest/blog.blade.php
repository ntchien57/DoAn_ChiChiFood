    ...
    <div class="breadcumb-wrapper background-image"
        ...
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Tin Tức<span class="font-style text-theme2"
                        style="text-transform: none; font-weight: normal;"> ChiChiFood</span></h1>
            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    <div class="as-blog blog-single has-post-thumbnail">
                        <div class="blog-img"><a href="javascript:;"><img src="assets/img/blog/blog_1_1.jpg"
                                    alt="Blog Image"></a></div>
                        <div class="blog-content">
                            <div class="blog-meta"><a href="javascript:;"><i class="far fa-user-alt"></i>Admin</a>
                                <a href="javascript:;"><i class="far fa-calendar-alt"></i>22/12/2022</a> <a
                                    href="javascript:;"><i class="far fa-comments"></i>Bình luận(3)</a>
                            </div>
                            <h2 class="blog-title">
                                <a href="javascript:;">Những món ăn "chỉ có" trong ngày Tết thời xưa</a>
                            </h2>
                            <p class="blog-text">Đây là những món ăn cực kì thịnh hành trong bữa cơm ngày Tết thời xưa.
                                Tuy nhiên, hiện tại những món ăn này không còn nữa
                            </p><a href="javascript:;" class="as-btn">Xem thêm<i
                                    class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    <div class="as-blog blog-single has-post-thumbnail">
                        <div class="blog-img"><a href="javascript:;"><img src="assets/img/blog/blog_1_2.jpg"
                                    alt="Blog Image"></a></div>
                        <div class="blog-content">
                            <div class="blog-meta"><a href="javascript:;"><i class="far fa-user-alt"></i>Admin</a>
                                <a href="javascript:;"><i class="far fa-calendar-alt"></i>22/12/2022</a> <a
                    ...
                    <div class="as-blog blog-single has-post-thumbnail">
                        <div class="blog-img"><a href="javascript:;"><img src="assets/img/blog/blog_1_3.jpg"
                                    alt="Blog Image"></a></div>
                        <div class="blog-content">
                            <div class="blog-meta"><a href="javascript:;"><i class="far fa-user-alt"></i>Admin</a>
                                <a href="javascript:;"><i class="far fa-calendar-alt"></i>22/12/2022</a> <a
                    ...
                    <div class="as-pagination">
                        <ul>
                            ...
                            <li><a href="javascript:;"><i class="far fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        <div class="widget widget_categories">
                            ...
                            <ul>
                                <li><img class="icon" src="assets/img/icon/suicao.svg">
                                    <a href="javascript:;">Sủi Cảo</a> <span>04</span>
                                </li>
                                <li><img class="icon" src="assets/img/icon/doisun.svg">
                                    <a href="javascript:;">Dồi Sụn</a> <span>03</span>
                                </li>
                                <li><img class="icon" src="assets/img/icon/nemchua.svg">
                                    <a href="javascript:;">Nem Chua Rán</a> <span>02</span>
                                </li>
                                <li><img class="icon" src="assets/img/icon/nemchua.svg">
                                    <a href="javascript:;">Khác</a> <span>01</span>
                                </li>
                            </ul>
                        </div>
                        <div class="widget">
                            <div class="author-widget-wrap">
                                <div class="avater"><img src="assets/img/testimonial/dqt-1.jpg" alt="chichifood"></div>
                                <div class="author-info">
                                    <h4 class="name"><a class="text-inherit" href="javascript:;">Đỗ Quốc Tuấn</a></h4>
                                </div>
                                <p class="author-bio">Giám Đốc Công Ty ChiChiFood</p>
                                <div class="author-social">
                                    <a href="javascript:;"><i class="fab fa-facebook-f"></i></a>
                                    <a href="javascript:;"><b>Zalo</b></a>
                                </div>
                            </div>
                        </div>
                        <div class="widget">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    <div class="media-img"><a href="javascript:;"><img
                                                src="assets/img/blog/blog_1_4.jpg"></a></div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="javascript:;">Những món ăn "chỉ có" trong ngày Tết thời xưa</a></h4>
                                        <div class="recent-post-meta"><a href="javascript:;"><i class="far fa-calendar-alt"></i>22/3/2022</a></div>
                                    </div>
                                </div>
                                <div class="recent-post">
                                    <div class="media-img"><a href="javascript:;"><img
                                                src="assets/img/blog/blog_1_3.jpg"></a></div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="javascript:;">Những món ăn "chỉ có" trong ngày Tết thời xưa</a></h4>
                                        <div class="recent-post-meta"><a href="javascript:;"><i class="far fa-calendar-alt"></i>22/3/2022</a></div>
                                    </div>
                                ...
                                <div class="recent-post">
                                    <div class="media-img"><a href="javascript:;"><img
                                                src="assets/img/blog/blog_1_2.jpg"></a></div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="javascript:;">Những món ăn "chỉ có" trong ngày Tết thời xưa</a></h4>
                                        <div class="recent-post-meta"><a href="javascript:;"><i class="far fa-calendar-alt"></i>22/3/2022</a></div>
                                    </div>
    ...
    <div class="" data-pos-for=".footer-wrapper" data-sec-pos="bottom-half">
        <div class="container">
            <div class="newsletter-wrap space" data-bg-src="assets/img/bg/subscribe_bg_1.jpg">
                ...
                <form class="newsletter-form"><input class="form-control" type="number"
